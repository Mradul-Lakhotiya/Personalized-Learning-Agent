...
│       ├── constants/
│       │   ├── nodeStatus.js       Node status enums
│       │   └── phases.js           App phase enums
│       ├── services/
│       │   ├── aiApi.js            Python backend fetch wrappers
│       │   └── pathApi.js          Go backend fetch wrappers
│       ├── utils/
│       │   └── graphLayout.js      Layout algorithm extracted from canvas
│       ├── context/
...
│           ├── layout/             Sidebar.jsx
│           ├── auth/               Auth.jsx
│           ├── graph/              GraphCanvas.jsx, CustomNode.jsx
│           ├── node/               NodeDetailPanel.jsx, QuestionCard.jsx
│           ├── path/               NewPathModal.jsx
│           └── survey/             SurveyCard.jsx
│
├── go-backend/                     Go State & CRUD API (Port 4000)
│   ├── main.go                     Slim routing setup
│   ├── db/
│   │   └── supabase.go             Supabase REST API helpers
│   ├── handlers/
...
│       ├── config.py               Centralized env var config (lru_cache singleton)
